          ...
          <div class="col navcol">
            ...
            <div>
                ...
                <b-container fluid>
                    ...
                    <b-row>
                        <b-col lg="11" style="padding-top:50px;">
                            <b-breadcrumb :items="items">
                                <template v-slot:title>
                                    <img class="sidebar_icon" src="./assets/d9account.svg" style="">Account
                                </template>
                            </b-breadcrumb>
                        </b-col>
                        <b-col lg="1">
                            ...
                            <b-tab  class="tabs2" title="ACCOUNT" active  style="backrground-color:red;">
                                ...
                                <b-form class="tabs3"  @submit="onSubmit" @reset="onReset">
                                    ...
                                    <b-row>
                                        ...
                                        <b-col lg="5">
                                            <b-form-group id="input-group-2" label="Create New Password" label-for="input-2">
                                                <b-form-input
                                                    id="input-2"
...
<!-- ACCOUNT DETAILS-->
                                    ...
                                    <b-row>
                                        <b-col lg="5">
                                            <b-form-group id="input-group-5" label="User name" label-for="input-5" description="You can not change this field">
                                                <b-form-input
                                                    id="input-5"
                                                    v-model="form.name"
                                                    required
